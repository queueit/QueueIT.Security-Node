...
module.exports = function(options)
{
    ...
    options.queryStringPrefix = options.queryStringPrefix || "";
        ...
        validate: function (req, res, callback) {
                ...
                !isNaN(queryValues.Timestamp))
            {
                ...
                if (this.verifyMd5Hash(getRedirectedUrl(req), expectedHash) && this.verifyTimestamp(queryValues.Timestamp))
                {
                    ...
                    var cookie = {
                        QueueId: queryValues.QueueId,
                        OriginalUrl: originalUrl,
                        PlaceInQueue: queryValues.PlaceInQueue,
                        RedirectType: queryValues.RedirectType,
                        Timestamp: timestamp,
                        Hash: this.generateHashForCookie(queryValues.QueueId, originalUrl, queryValues.PlaceInQueue, queryValues.RedirectType, timestamp, expiration),
