...
module.exports = function(options)
{
    ...
    return {
                ...
                !isNaN(req.query.ts))
            {
                ...
                if (this.verifyMd5Hash(redirectedUrl, expectedHash) && this.verifyTimestamp(req.query.ts))
                {
                    ...
                    var cookie = {
                        ...
                        Hash: this.generateHashForCookie(req.query.q, redirectedUrl, timestamp, expiration),
        ...
        {
            var valueToHash = queueId + originalUrl + placeInQueue + redirectType + timestamp + expires + options.secretKey;
